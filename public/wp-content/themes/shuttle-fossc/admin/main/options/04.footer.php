...
function fossc_input_copyright() {

	printf( __( 'Developed by %1$s. Powered by %2$s.', 'shuttle' ) , '<a href="https://fossc.org.uk/" target="_blank">FOSSC</a>', '<a href="//www.wordpress.org/" target="_blank">WordPress</a>'); 
}
